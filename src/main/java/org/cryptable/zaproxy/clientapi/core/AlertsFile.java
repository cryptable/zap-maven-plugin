...
public class AlertsFile {
    public static void saveAlertsToFile(List<org.cryptable.zaproxy.clientapi.core.Alert> requireAlerts, List<org.cryptable.zaproxy.clientapi.core.Alert> reportAlerts, List<org.cryptable.zaproxy.clientapi.core.Alert> ignoredAlerts, File outputFile) throws JDOMException, IOException {
        ...
        if (ignoredAlerts.size() > 0){
            ...
            for (org.cryptable.zaproxy.clientapi.core.Alert alert : ignoredAlerts){
    ...
    private static void createAlertXMLElements(Element alertsFound, org.cryptable.zaproxy.clientapi.core.Alert alert) {
    ...
    public static List<org.cryptable.zaproxy.clientapi.core.Alert> getAlertsFromFile(File file, String alertType) throws JDOMException, IOException {
        List<org.cryptable.zaproxy.clientapi.core.Alert> alerts =  new ArrayList<>();
        ...
        for (Element element: alertElements){
            org.cryptable.zaproxy.clientapi.core.Alert alert = new org.cryptable.zaproxy.clientapi.core.Alert(
