...
public class ApiResponseSet extends ApiResponse {
	...
	public ApiResponseSet(Node node) throws ClientApiException {
		...
		while (child != null) {
			org.cryptable.zaproxy.clientapi.core.ApiResponseElement elem = (org.cryptable.zaproxy.clientapi.core.ApiResponseElement) org.cryptable.zaproxy.clientapi.core.ApiResponseFactory.getResponse(child);
