...
import org.cryptable.zaproxy.clientapi.core.Alert.Confidence;
import org.cryptable.zaproxy.clientapi.core.Alert.Risk;
import org.cryptable.zaproxy.clientapi.gen.Acsrf;
import org.cryptable.zaproxy.clientapi.gen.AjaxSpider;
import org.cryptable.zaproxy.clientapi.gen.Ascan;
import org.cryptable.zaproxy.clientapi.gen.Authentication;
import org.cryptable.zaproxy.clientapi.gen.Autoupdate;
import org.cryptable.zaproxy.clientapi.gen.Break;
import org.cryptable.zaproxy.clientapi.gen.Context;
import org.cryptable.zaproxy.clientapi.gen.Core;
import org.cryptable.zaproxy.clientapi.gen.ForcedUser;
import org.cryptable.zaproxy.clientapi.gen.HttpSessions;
import org.cryptable.zaproxy.clientapi.gen.ImportLogFiles;
import org.cryptable.zaproxy.clientapi.gen.Params;
import org.cryptable.zaproxy.clientapi.gen.Pnh;
import org.cryptable.zaproxy.clientapi.gen.Pscan;
import org.cryptable.zaproxy.clientapi.gen.Script;
import org.cryptable.zaproxy.clientapi.gen.Search;
import org.cryptable.zaproxy.clientapi.gen.SessionManagement;
import org.cryptable.zaproxy.clientapi.gen.Spider;
import org.cryptable.zaproxy.clientapi.gen.Users;
...
public class ClientApi {
	...
	private int statusToInt(org.cryptable.zaproxy.clientapi.core.ApiResponse response) {
		return Integer.parseInt(((org.cryptable.zaproxy.clientapi.core.ApiResponseElement)response).getValue());
	}

	public void checkAlerts (List<org.cryptable.zaproxy.clientapi.core.Alert> ignoreAlerts, List<org.cryptable.zaproxy.clientapi.core.Alert> requireAlerts) throws ClientApiException {
        HashMap<String,List<org.cryptable.zaproxy.clientapi.core.Alert>> results = checkForAlerts(ignoreAlerts, requireAlerts);
        verifyAlerts(results.get("requireAlerts"), results.get("reportAlerts"));
	}

    private void verifyAlerts(List<org.cryptable.zaproxy.clientapi.core.Alert> requireAlerts, List<org.cryptable.zaproxy.clientapi.core.Alert> reportAlerts) throws ClientApiException {
        StringBuilder sb = new StringBuilder();
        if (reportAlerts.size() > 0) {
            sb.append("Found ").append(reportAlerts.size()).append(" alerts\n");
            for (org.cryptable.zaproxy.clientapi.core.Alert alert: reportAlerts) {
                sb.append('\t');
        ...
        if (requireAlerts != null && requireAlerts.size() > 0) {
            ...
            for (org.cryptable.zaproxy.clientapi.core.Alert alert: requireAlerts) {
                sb.append('\t');
                sb.append(alert.toString());
                sb.append('\n');
            }
    ...
    public void checkAlerts(List<org.cryptable.zaproxy.clientapi.core.Alert> ignoreAlerts, List<org.cryptable.zaproxy.clientapi.core.Alert> requireAlerts, File outputFile) throws ClientApiException {
        HashMap<String,List<org.cryptable.zaproxy.clientapi.core.Alert>> results = checkForAlerts(ignoreAlerts, requireAlerts);
    ...
    public List<org.cryptable.zaproxy.clientapi.core.Alert> getAlerts(String baseUrl, int start, int count) throws ClientApiException {
    	List<org.cryptable.zaproxy.clientapi.core.Alert> alerts = new ArrayList<org.cryptable.zaproxy.clientapi.core.Alert>();
        org.cryptable.zaproxy.clientapi.core.ApiResponse response = core.alerts(baseUrl, String.valueOf(start), String.valueOf(count));
        if (response != null && response instanceof org.cryptable.zaproxy.clientapi.core.ApiResponseList) {
            org.cryptable.zaproxy.clientapi.core.ApiResponseList alertList = (org.cryptable.zaproxy.clientapi.core.ApiResponseList)response;
            for (org.cryptable.zaproxy.clientapi.core.ApiResponse resp : alertList.getItems()) {
            	org.cryptable.zaproxy.clientapi.core.ApiResponseSet alertSet = (org.cryptable.zaproxy.clientapi.core.ApiResponseSet)resp;
                alerts.add(new org.cryptable.zaproxy.clientapi.core.Alert(
    ...
    private HashMap<String, List<org.cryptable.zaproxy.clientapi.core.Alert>> checkForAlerts(List<org.cryptable.zaproxy.clientapi.core.Alert> ignoreAlerts, List<org.cryptable.zaproxy.clientapi.core.Alert> requireAlerts) throws ClientApiException {
        List<org.cryptable.zaproxy.clientapi.core.Alert> reportAlerts = new ArrayList<>();
        List<org.cryptable.zaproxy.clientapi.core.Alert> ignoredAlerts = new ArrayList<>();
        List<org.cryptable.zaproxy.clientapi.core.Alert> alerts = getAlerts(null, -1, -1);
        for (org.cryptable.zaproxy.clientapi.core.Alert alert : alerts) {
            boolean ignore = false;
            if (ignoreAlerts != null) {
                for (org.cryptable.zaproxy.clientapi.core.Alert ignoreAlert : ignoreAlerts) {
            ...
            if (requireAlerts != null) {
                for (org.cryptable.zaproxy.clientapi.core.Alert requireAlert : requireAlerts) {
        ...
        HashMap<String, List<org.cryptable.zaproxy.clientapi.core.Alert>> results = new HashMap<>();
	...
	public org.cryptable.zaproxy.clientapi.core.ApiResponse callApi (String component, String type, String method,
                                                                     Map<String, String> params) throws ClientApiException {
		Document dom = this.callApiDom(component, type, method, params);
		return org.cryptable.zaproxy.clientapi.core.ApiResponseFactory.getResponse(dom.getFirstChild());
	}
    ...
    private List<String> getSessionUrls() throws Exception {
        ...
        org.cryptable.zaproxy.clientapi.core.ApiResponse response = core.urls();
        if (response != null && response instanceof org.cryptable.zaproxy.clientapi.core.ApiResponseList) {
            org.cryptable.zaproxy.clientapi.core.ApiResponseElement urlList = (org.cryptable.zaproxy.clientapi.core.ApiResponseElement) ((org.cryptable.zaproxy.clientapi.core.ApiResponseList) response).getItems().get(0);
            for (org.cryptable.zaproxy.clientapi.core.ApiResponse element: ((org.cryptable.zaproxy.clientapi.core.ApiResponseList) response).getItems()){
                URL url = new URL(((org.cryptable.zaproxy.clientapi.core.ApiResponseElement)element).getValue());
