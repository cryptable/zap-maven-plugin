...
public class ClientApiMain {
    ...
    private Task task;
    private org.cryptable.zaproxy.clientapi.core.ClientApi api;
        ...
        try {
            switch(task){
                ...
                case checkAlerts:
                    ...
                    break;
                case showAlerts:
                	List<org.cryptable.zaproxy.clientapi.core.Alert> alerts = api.getAlerts(null, -1, -1);
    ...
    private void initialize(String[] args) {
        ...
        api = new org.cryptable.zaproxy.clientapi.core.ClientApi(zapaddr, zapport, debug);
    }
